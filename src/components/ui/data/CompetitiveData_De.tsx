...
export const competitiveDataDe: CompetitiveItem[] = [
  {
  ...
  },
  {
    ...
    title: "SPRACHKOMPETENZEN",
  },
];

export const titleCompetitivoDe:string ="Als HR-Beratung können wir Ihnen auch bei Folgendem helfen";